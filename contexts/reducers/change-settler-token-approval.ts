...
const reducer = (state: ApplicationState, payload): ApplicationState =>
  ({...state, isSettlerTokenApproved: payload})
...
export const changeSettlerTokenApproval = (payload: boolean): ReduceActor<boolean> => ({name: ReduceActionName.ChangeSettlerTokenApproval, payload});
