...
const reducer = (state: ApplicationState, payload): ApplicationState =>
  ({...state, isTransactionalTokenApproved: payload})
...
export const changeTransactionalTokenApproval = (payload: boolean): ReduceActor<boolean> => ({name: ReduceActionName.ChangeTransactionalTokenApproval, payload});
