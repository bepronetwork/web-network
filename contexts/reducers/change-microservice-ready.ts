...
const reducer = (state: ApplicationState, payload: boolean): ApplicationState =>
  ({...state, microServiceReady: payload})
...
export const changeMicroServiceReady = (payload: boolean): ReduceActor<boolean> => ({name: ReduceActionName.ChangeMicroServiceReadyState, payload});
