...
export const changeBalance = (payload: Partial<BalanceState>|BalanceState): ReduceActor<Partial<BalanceState>|BalanceState> => ({name: ReduceActionName.ChangeBalance, payload});
