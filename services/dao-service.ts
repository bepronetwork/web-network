...
export default class DAO {
  ...
  async cancelBounty(bountyId: number, isFundingRequest?: boolean): Promise<TransactionReceipt> {
    if (isFundingRequest) return this.network.cancelFundRequest(bountyId);
