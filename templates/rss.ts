            ...
            <description>
                <![CDATA[ 
                    <div>
                        ...
                        <div>
                            {{#each tags}}
                                <span style="color: white; background-color: #4250e4; font-weight: bold; text-transform: uppercase; border-radius: 8px; border: 1px; solid #4250e4; padding: 2px 6px; margin-right: 2px;">
                                    #{{tag}}
                                </span>
                            {{/each}}
                        </div>
