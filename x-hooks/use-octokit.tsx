...
export default function useOctokit() {
  ...
  async function getPullRequestReviews(pull_number: number, path: string) {
    return octokit.rest.pulls.listReviews({...getOwnerRepoFrom(path), pull_number})
  }
  ...
  return {getIssue, getIssueComments, getCommitsOfPr, getForksOf, getUserRepos, getStargazers, authenticate, getParticipants, listBranches, getPullRequest, getPullRequestReviews};
