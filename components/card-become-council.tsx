  ...
  return (
    <div className="become-council p-2 ps-4 pb-3">
      <div className="d-flex d-flex justify-content-end">
        <Button transparent className="card-close-button p-1" onClick={() => setShow(false)}>
          <CloseIcon
      ...
      <span
              dangerouslySetInnerHTML={{
                __html: highlightText(t("become-council-description", {
                    amount: formatNumberToNScale(activeNetwork?.councilAmount),
