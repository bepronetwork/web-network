    ...
    <div className="container">
      <div className="row justify-content-center">
        <div className="col-md-10 mb-5">
          ...
          <div className="mb-3">
            <p className="p-small mb-0">Small Caption / Use .caption-small</p>
            <p className="caption-small">Build the future of DeFi Gaming</p>
          </div>
          <div className="mb-3">
            <p className="p-small mb-0">Paragraph / Use .p</p>
            <p className="p w-50">
              Use $BEPRO to propose new features, new products or to get
              technical support from the BEPRO.network engineers´ community.
            </p>
          </div>
          <div className="mb-3">
            <p className="p-small mb-0">Small Paragraph / Use .p-small</p>
          ...
          <div className="d-flex justify-content-between mb-3">
            <div className="d-flex flex-column">
              ...
              <button className="btn btn-md btn-primary mb-2">
                Primary button
              </button>
              <button className="btn btn-lg btn-primary mb-2">
                Primary button
              </button>
            </div>
            <div className="d-flex flex-column">
              <p className="p-small mb-2">.btn-white</p>
              <button className="btn btn-sm btn-white mb-2">
                White button
              </button>
              <button className="btn btn-white mb-2">White button</button>
              <button className="btn btn-md btn-white mb-2">
                White button
              </button>
            ...
            <div className="d-flex flex-column">
              ...
              <button className="btn btn-sm btn-trans mb-2">
                Transparent button
              </button>
              <button className="btn btn-trans mb-2">Transparent button</button>
              <button className="btn btn-md btn-trans mb-2">
                Transparent button
              </button>
              <button className="btn btn-lg btn-trans mb-2">
                Transparent button
              </button>
            </div>
          </div>
