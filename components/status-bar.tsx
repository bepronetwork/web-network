...
export default function StatusBar() {
  ...
  return (<>
    <div className="position-fixed bg-dark bottom-0 w-100 px-3 py-3 d-flex justify-content-between" id="status-bar">
      ...
      <div className="d-flex align-items-center">
        <p className="text-uppercase fs-7 mb-0 text-center family-regular ">
          Bepro Network Services and BEPRO Token ($BEPRO) are not available in Excluded Jurisdictions. 
          <br/>By accessing and using the interface you agree with our <a href="https://www.bepro.network/terms-and-conditions" className="text-decoration-none">{`Terms & Conditions`}</a>
        </p>
      </div>
      <div className="d-flex align-items-center"/>
    </div>
