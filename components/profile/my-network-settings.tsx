...
export default function MyNetworkSettings({
  ...
  const { handleChangeNetworkParameter, handleAddNetworkToRegistry } =
    useBepro();
  ...
  const TABS = [
    ...
    },
    {
      ...
      title: "Repositories",
      component: <ContainerTab>{renderRepositoriesList()}</ContainerTab>,
    },
    {
      eventKey: "governance",
      title: "Governance",
      component: <ContainerTab>{renderGovernance()}</ContainerTab>,
    },
    {
      eventKey: "registry",
      title: "Registry",
      component: <ContainerTab>{renderRegistry()}</ContainerTab>,
    },
  ];
        ...
        <Row className="mb-4 align-items-end">
          ...
          <Col xs="auto">
            <Button
              color="dark-gray"
              disabled={
                !isAbleToClosed || isClosing || !state.currentUser?.login
              }
              className="ml-2"
  ...
  function renderRegistry() {
    return <RegistrySettings isGovernorRegistry={isGovernorRegistry} />;
  }
  ...
  function renderGovernance() {
    return (
      <>
        ...
        <Row className="mt-4">
          <TokensSettings
            setCurrentSelectedTokens={setCurrentSelectedTokens}
            defaultSelectedTokens={network?.tokens}
          />
        </Row>
        {renderSaveButton()}
      </>
