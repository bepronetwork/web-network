  ...
  return (
    <span>
      <OverlayTrigger
        ...
        overlay={overlay}>
          <>
            <Button className='me-3' transparent rounded opacity={75} onClick={() => setShowOverlay(!showOverlay)}>{loading && <span className="spinner-border spinner-border-sm"/> || <TransactionIcon color="bg-opac"/>}</Button>
          </>
    </OverlayTrigger>
